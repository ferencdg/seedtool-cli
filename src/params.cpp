...
void Params::validate_input_format()
{
    ...
    else
    {
        ...
        else
        {
            ...
            switch (k)
            {
            case Format::Key::random:
                input_format = new FormatRandom();
                break;
            case Format::Key::hex:
                input_format = new FormatHex();
                break;
            case Format::Key::bits:
                input_format = new FormatBits();
                break;
            case Format::Key::cards:
                input_format = new FormatCards();
                break;
            case Format::Key::dice:
                input_format = new FormatDice();
                break;
            case Format::Key::base6:
                input_format = new FormatBase6();
                break;
            case Format::Key::base10:
                input_format = new FormatBase10();
                break;
            case Format::Key::ints:
                input_format = new FormatInts();
                break;
            case Format::Key::bip39:
                input_format = new FormatBIP39();
                break;
            case Format::Key::sskr:
                input_format = new FormatSSKR();
                break;
            case Format::Key::bytewords:
                input_format = new FormatBytewords();
                break;
            case Format::Key::bytewords_uri:
                input_format = new FormatBytewordsURI();
                break;
            case Format::Key::bytewords_minimal:
                input_format = new FormatBytewordsMinimal();
                break;
            default:
...
void Params::validate_output_format()
{
    ...
    else
    {
        ...
        case Format::Key::hex:
            ...
            break;
        case Format::Key::bits:
            output_format = new FormatBits();
            break;
        case Format::Key::cards:
            output_format = new FormatCards();
            break;
        case Format::Key::dice:
            output_format = new FormatDice();
            break;
        case Format::Key::base6:
            output_format = new FormatBase6();
            break;
        case Format::Key::base10:
            output_format = new FormatBase10();
            break;
        case Format::Key::ints:
            output_format = new FormatInts();
            break;
        case Format::Key::bip39:
            output_format = new FormatBIP39();
            break;
        case Format::Key::sskr:
            output_format = new FormatSSKR();
            break;
        case Format::Key::bytewords:
            output_format = new FormatBytewords();
            break;
        case Format::Key::bytewords_uri:
            output_format = new FormatBytewordsURI();
            break;
        case Format::Key::bytewords_minimal:
            output_format = new FormatBytewordsMinimal();
            break;
        default:
